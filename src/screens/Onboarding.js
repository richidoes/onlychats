...
import { Image, StyleSheet, View as DefaultView, Alert } from 'react-native';
...
export default function Onboarding() {
  ...
  async function handleOnContinue() {
    try {
      ...
      Alert.alert('Error registering push notifications', e);
    }
  }
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center' }}>
      ...
      {appFeatures.map(feature => (
        <View key={feature.title} style={styles.itemContainer}>
